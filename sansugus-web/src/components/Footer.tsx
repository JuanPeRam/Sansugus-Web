    ...
    return(
        <footer className='footer-main'>
            ...
            <div className="footer-item footer-social">
                <svg onClick={()=>openLink(links['Instagram'])} xmlns="http://www.w3.org/2000/svg" height="3em" viewBox="0 0 448 512">
                ...
                <svg onClick={()=>openLink(links['TikTok'])} xmlns="http://www.w3.org/2000/svg" height="3em" viewBox="0 0 448 512">
