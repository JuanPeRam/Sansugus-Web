    ...
    return (
        <>
            ...
            <section className='grid lg:grid-cols-10 auto-rows-[10rem] gap-5 w-full max-w-[1500px] md:grid-cols-5'>
                <article className='one rounded-xl justify-center col-span-5 row-span-3 border p-5'>
                    <h2 className='text-2xl text-center w-full'>Próximo Partido</h2>
                    <NextMatch/>
                </article>
                <article className='two rounded-xl justify-center col-span-5 row-span-2 border p-5'>
